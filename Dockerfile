...
# docker build -t cho_viet .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name cho_viet cho_viet
...
# Install base packages (imagemagick for Active Storage variants)
